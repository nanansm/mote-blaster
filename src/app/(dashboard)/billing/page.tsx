...
export default function BillingPage() {
  ...
  return (
    <div className="p-8 space-y-6 max-w-2xl">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className={`text-3xl font-bold mt-2 ${isPro ? 'text-blue-600' : 'text-slate-700'}`}>
              {isPro ? '⭐ Pro' : 'Free'}
            </p>
          </div>
          {isPro && subscription && (
      ...
      {/* Upgrade / Cancel */}
      {!isPro ? (
        <div className="rounded-xl border-2 border-blue-500 bg-blue-600 p-6 text-white">
          ...
          <p className="text-3xl font-bold mt-4">{formatRupiah(99000)}<span className="text-base font-normal text-blue-200">/bulan</span></p>
          ...
          <Button
            className="mt-6 bg-white text-blue-600 hover:bg-blue-50 w-full"
